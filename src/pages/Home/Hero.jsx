...
export default function Hero() {
  return (
    <section className="px-8 w-full max-w-6xl mx-auto pt-18 md:pt-4 pb-8">
      <div className="w-full flex flex-col md:flex-row gap-12 md:gap-48 justify-between  items-center  font-display ">

        <div className="flex flex-col items-center gap-7 md:items-start w-full md:w-3/5">
