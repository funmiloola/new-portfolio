...
export default function Skills() {
    return (
        <div className='max-w-6xl w-full px-8 mx-auto pt-10 md:pt-20 font-sans pb-8'>
            ...
            <p className='text-white text-center  text-base pb-2 '>These are the technologies and tools I've been working with to build beautiful and functional web experiences.</p>
