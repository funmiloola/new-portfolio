  ...
  return (
    <div className="flex justify-between gap-1 items-center px-8 w-full max-w-6xl mx-auto pt-4">
     ...
     <div className="flex items-center justify-center gap-2 md:gap-8">
        <ul onClick={()=>setOptions(false)} className={`  ${option ? "fixed  z-10 top-0 left-0 w-[60%] px-6 pt-4 bg-slate-300 dark:bg-[#353434] inset-0 min-h-screen h-full flex flex-col gap-5 " : "hidden md:flex  gap-20"}`}>
        <Link to="/">
          <li
            onClick={() => setIsActive("/")}
